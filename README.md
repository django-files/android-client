...
<a href="https://django-files.github.io/">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=django-files/django-files,django-files/ios-client,django-files/android-client,django-files/web-extension&type=date&legend=top-left&theme=dark" />
